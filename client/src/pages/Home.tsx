        ...
        <section className="hero-section">
          ...
          <div className="hero-copy reveal">
            ...
            <div className="hero-actions">
              ...
              <a className="button button-outline" href="/manus-storage/Carlo_Corro_CV_Photo_Free_Portfolio_QR_0f25164d.pdf" target="_blank" rel="noreferrer"><Download size={16} /> Download CV</a>
